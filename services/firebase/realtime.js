...
import { getDatabase, ref, set, get, update, remove, push, onValue, serverTimestamp } from 'https://www.gstatic.com/firebasejs/10.7.1/firebase-database.js';
...
class FirebaseRealtimeService {
    ...
    async push(path, data) { this.init(); const r = push(ref(this.db, path)); await set(r, { ...data, id: r.key }); return { id: r.key, ...data }; }
